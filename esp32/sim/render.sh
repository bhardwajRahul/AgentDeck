...
BOARDS_DEFAULT="box_86 ips35 amoled ttgo ips10 t_embed t_display_pro led8x32 trmnl_75 nm_epd_420_preview lilygo_epd47_preview lilygo_epd47_notouch_preview"
BOARD="${1:-}"
SCENE="${2:-}"
