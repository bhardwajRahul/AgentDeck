...
| **Apple App Store** — macOS + iPhone/iPad | `apple-v*` | **1.4.0 release preparation in progress** (Codex setup recovery, z.ai usage, and preview improvements); **1.3.2 remains the last verified live version on both platforms**, independently verified as `READY_FOR_SALE` on 2026-09-21 by [App Store Connect API](https://github.com/puritysb/AgentDeck/actions/runs/35542645924). |
